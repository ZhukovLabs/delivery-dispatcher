    ...
    if not STATE.get("points"):
        ...
        STATE["points"] = [
            {"id": uuid.uuid4().hex[:8], "name": "Подгорная",
             ...
             "lat": 52.44175257524367, "lng": 31.01451536558636},
            {"id": uuid.uuid4().hex[:8], "name": "Барыкина",
             "address": "ул. Барыкина 230Б, Гомель",
             "lat": 52.42326128535596, "lng": 30.934022390208472},
        ]
        _persist_meta()
...
def _invalidate_plan(drop_plan=False, pid=None, courier_id=None, geo=False):
    ...
    drop_plan=True ΓÇö ╤ü╤é╨░╤Ç╤ï╨╣ ╨┐╨╗╨░╨╜ ╤é╨╛╤ç╨╜╨╛ ╨╜╨╡╨▓╨░╨╗╨╕╨┤╨╡╨╜ (╤â╨┤╨░╨╗╨╡╨╜╨╕╨╡ ╨╖╨░╨║╨░╨╖╨░/╨║╤â╤Ç╤î╨╡╤Ç╨░,
    ╤ü╨╝╨╡╨╜╨░ ╨┤╨╡╨┐╨╛): ╤ü╨▒╤Ç╨░╤ü╤ï╨▓╨░╨╡╨╝ ╤ü╤Ç╨░╨╖╤â. ╨ÿ╨╜╨░╤ç╨╡ ╨┐╨╗╨░╨╜ ╨┐╨╛╨║╨░╨╖╤ï╨▓╨░╨╡╤é╤ü╤Å ╤ü ╨┐╨╛╨╝╨╡╤é╨║╨╛╨╣
    ┬½╤â╤ü╤é╨░╤Ç╨╡╨╗┬╗, ╨┐╨╛╨║╨░ ╨░╨┤╨╝╨╕╨╜╨╕╤ü╤é╤Ç╨░╤é╨╛╤Ç ╨╜╨╡ ╨╜╨░╨╢╨╝╤æ╤é ┬½╨á╨░╤ü╤ü╤ç╨╕╤é╨░╤é╤î┬╗.
    courier_id ΓÇö ╨║╤â╤Ç╤î╨╡╤Ç-╤ü╨┐╨╡╤å╨╕╤ä╨╕╤ç╨╜╨░╤Å ╨╕╨╜╨▓╨░╨╗╨╕╨┤╨░╤å╨╕╤Å (╤ü╨╝╨╡╨╜╨░ ╤ü╤é╨░╤é╤â╤ü╨░, ╤â╨┤╨░╨╗╨╡╨╜╨╕╨╡,
    ╨▓╨╛╨╖╨▓╤Ç╨░╤é ╨╜╨░ ╨▒╨░╨╖╤â, ╨┐╨╡╤Ç╨╡╨▓╨╛╨┤ ╨▓ ╨┤╤Ç╤â╨│╨╛╨╡ ╨┤╨╡╨┐╨╛): ╨╕╨╖ ╨▓╤ü╨╡╤à ╨┐╨╗╨░╨╜╨╛╨▓ ╤â╨▒╨╕╤Ç╨░╤Ä╤é╤ü╤Å ╤é╨╛╨╗╤î╨║╨╛
    ╨╝╨░╤Ç╤ê╤Ç╤â╤é╤ï ╤ì╤é╨╛╨│╨╛ ╨║╤â╤Ç╤î╨╡╤Ç╨░, ╨╝╨░╤Ç╤ê╤Ç╤â╤é╤ï ╨╛╤ü╤é╨░╨╗╤î╨╜╤ï╤à ╨║╤â╤Ç╤î╨╡╤Ç╨╛╨▓ ╤ü╨╛╤à╤Ç╨░╨╜╤Å╤Ä╤é╤ü╤Å
